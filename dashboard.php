...
<h2 style="margin-top:9px;  font-weight:bold; " align="left">LISTADO DE CURSOS </h2>
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <th style="background-color:#666666; color:#FFFFFF"></th>
              <th style="background-color:#666666; color:#FFFFFF"></th>
                <th style="background-color:#666666; color:#FFFFFF"></th>
     </tr>
  ...
  <tr>
       <?php
//MUESTRA TODOS LOS CURSOS EN UNA TABLA PARA LUEGO ESPERAR ALGUNA ACCION

    $objCurso = new Cursos();
$sel = $objCurso->getListCursos();
  //print_r ( $sel);
foreach($sel as $reg){
  $tit=$reg['titulo'];
  $est=$reg['estado'];
    ...
    <td ><?php echo $reg['titulo'];?></td>
      ...
      <td ><a href="view.php?var1=<?php echo $tit ?>" > <button  class="btn btn-primary" >VER DETALLE</button></a></td>
      <td ><a href="edit.php?var1=<?php echo $tit ?>" > <button  class="btn btn-warning" >MODIFICAR CURSO</button></a></td>
      <td ><a href="course/delete.php?var1=<?php echo $tit ?>" onClick="return confirm('Desea eliminar el curso?');"> <button  class="btn btn-danger" >BORRAR CURSO</button></a></td>
   </tr>
     <?php
