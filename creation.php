...
<h2 style="margin-top:9px;  font-weight:bold; " align="left">CREACION DE CURSOS </h2>
    ...
    <p class="login-box-msg">Ingresa los datos requeridos</p>
      ...
      <div class="form-group has-feedback">
        <input type="text" name="titulo" class="form-control" placeholder="INGRESE EL TITULO DEL CURSO" pattern="[A-Za-z0-9_-$/ ]{1,15}" required>
       
      </div>
      <div class="form-group has-feedback">
        <input type="text" name="descripcion" class="form-control" placeholder="INGRESE LA DESCRIPCION DEL CURSO" pattern="[A-Za-z0-9_-$/ ]{1,15}" required>
    ...
    <option value="activo">ACTIVO</option>
      ...
      <div class="row" align="center">
        ...
        <div class="col-xs-8" align="center" style="float:none">
          <button type="submit" class="btn btn-primary btn-block btn-flat" >CREAR CURSO</button>
        </div>
         </form>
         ...
         <!-- CIERRE FORMULARIO DE CREACION DE CURSOS -->
    </section>
    <!-- /.content -->
